...
The Onit protocol consists of smart contracts, an API, and an SDK that anyone can use to deploy their own markets, and a few teams are already using these.
